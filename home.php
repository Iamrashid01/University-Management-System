...
<body >
<div class="logo-img">
	<a href="about.php"><img src="Images/tiu.png" width="400px"></a>
</div> 
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/1.16.1/TweenMax.min.js'></script><script  src="./script.js"></script>

<div id="background">
    <img src="Images/home.jpg" class="stretch" alt="" />
</div>

<div style="float: right; margin-right: 400px; margin-top: 20px">
<h2>Welcome to the online portal of TIU. Choose an Option.</h2><br>
<table align="center" cellspacing="15px">
  <div class="logo-img">
   <tr>
	 <td>
        <a href="admin_login.php" class="h_button" title="Admin Login"><img class="img-circle" src="Images/admin.svg" width="150" height="100"/></a>
	</td>
	<td>
	<a href="login_student.php" class="h_button" title="Student Login"><img class="img-circle" src="Images/s1.png" width="150" height="100"/></a>
	</td>
   </tr>
   <tr>
	<td>
	<h2 style="text-indent: 1em;">Admin Login</h2>
	</td>
	<td>
	<h2 style="text-indent: 1em;">Student Login</h2>
	</td>
   </tr>
   <tr>
	<td>
	<a href="login_teacher.php" class="h_button" title="Teacher Login"><img class="img-circle" src="Images/t1.png" width="150" height="100"/></a>
	</td>
	<td>
	<a href="about.php" class="h_button" title="About us"><img class="img-circle" src="Images/info.png" width="150" height="100"/></a>
	</td>
   </tr>
   <tr>
	<td>
	<h2 style="text-indent: 1em;">Teacher Login</h2>
	</td>
	<td>
	<h2 style="text-indent: 1em;">About Us</h2>
	</td>
   </tr>
</table>
</div>
