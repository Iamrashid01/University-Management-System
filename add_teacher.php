...
<div id="formdiv">
	<div id="inputbox">
	 ...
	 <input type="text" id="salary" name="salary" class="box"  required>
	 </div><br>
 ...
 { 
	...
	{   
	   ...
	   $row_cnt = mysqli_num_rows($query);
           if($row_cnt==0)
	   {
              $query1 = mysqli_query($link,"insert into teacher (t_name,gender,e_id,dob,address,phone,t_dep,tkey,salary) values ('".$name."','".$gender."','".$eid."','".$dob."','".$address."','".$phone."','".$dept."','".$keyh."','".$salary."')"); 
	      if($query1)
	      {
