	...
	<div id="inputbox">
     ...
     <select name="cname" id="cname">
		...
		<?php
          ...
          $query = mysqli_query($link,"select distinct(course_id),c_name from course natural join course_dep where c_sem = '".$_SESSION['user_sem']."' and dep_id = '".$_SESSION['user_dep']."'");
          //$row_cnt = mysqli_num_rows($query);
	      //if($row_cnt==0)
		  //{
		  //    echo "No available courses .. redirecting ...";
